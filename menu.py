...
def combat_attack(current_enemy, test_combat_rect, combat_level_text, combat_hull_text, test_combat_health_bar):
    ...
    #weapon_tooltip_rect = cls.custom_label_custom_pos_custom_text_pos(game_display, 0, 0, 500, 500, options_black, 'Damage: 50', white, 0 + 10, 0 + 10, 'Arial', 20, True, False)
        ...
        for ev in pg.event.get():
            ...
            if ev.type == pg.QUIT:
                ...
                for k in range(0, len(ship.equipped_weapons)):
                    ...
                    weapon_tooltip_rect = cls.custom_label_custom_pos_custom_text_pos(game_display, weapon_tooltipX, weapon_tooltipY, weapon_tooltipW, weapon_tooltipH, options_black, 'Damage: ' + str(weapon.damage), white, weapon_tooltipX + 10, weapon_tooltipY + 10, 'Arial', 20, True, False)
                    ...
                    while not outside_button:
                        for ev in pg.event.get():
                            ...
                            if ev.type == pg.QUIT:
                                gv.end_game = True
                                has_attacked = True
                            elif weapon_bars[k].rect.collidepoint(mpos):
                                pass
                            #elif weapon_bars[k].rect.collidepoint(mpos):
                            #elif not weapon_bars[k].rect.collidepoint(mpos):
                            else:
                                outside_button = True
                                ''''''
                                showMenuTemplate()
...
if 0 in range(0, len(ship.equipped_weapons)):
    ...
    menu_combat_bar_weapon1 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX, menu_combat_bar_weaponY, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)
...
if 1 in range(0, len(ship.equipped_weapons)):
    ...
    menu_combat_bar_weapon2 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX, menu_combat_bar_weaponY + menuHeight / 2.2, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)


if 2 in range(0, len(ship.equipped_weapons)):
    menu_combat_bar_weapon3 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 320, menu_combat_bar_weaponY, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, ship.equipped_weapons[2].name, menu_black, 'Arial', 20, True, False)

else:
    menu_combat_bar_weapon3 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 320, menu_combat_bar_weaponY, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)

if 3 in range(0, len(ship.equipped_weapons)):
    menu_combat_bar_weapon4 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 320, menu_combat_bar_weaponY + menuHeight / 2.2, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, ship.equipped_weapons[3].name, menu_black, 'Arial', 20, True, False)

else:
    menu_combat_bar_weapon4 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 320, menu_combat_bar_weaponY + menuHeight / 2.2, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)

if 4 in range(0, len(ship.equipped_weapons)):
    menu_combat_bar_weapon5 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 640, menu_combat_bar_weaponY, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, ship.equipped_weapons[4].name, menu_black, 'Arial', 20, True, False)

else:
    menu_combat_bar_weapon5 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 640, menu_combat_bar_weaponY, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)

if 5 in range(0, len(ship.equipped_weapons)):
    menu_combat_bar_weapon6 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 640, menu_combat_bar_weaponY + menuHeight / 2.2, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, ship.equipped_weapons[5].name, menu_black, 'Arial', 20, True, False)

else:
    menu_combat_bar_weapon6 = cls.custom_label_custom_pos_center(game_display, menu_combat_bar_weaponX + 640, menu_combat_bar_weaponY + menuHeight / 2.2, menu_combat_bar_weaponW, menu_combat_bar_weaponH, white, '', menu_black, 'Arial', 20, True, False)
