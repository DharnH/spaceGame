...
def startGame():
    ...
    ship_name = ''
    shipInside()
    mainLoop(end_game, game_display, clock, keep_options, ship_name)



def mainLoop(end_game, game_display, clock, keep_options, ship_name):
                                ...
                                if ev.type == pg.QUIT:
                                    ...
                                    if ev.key == pg.K_RETURN:
                                        ...
                                        if current_textW + letterW < name_label_custom.rectW - (name_label_custom.rectW / 10):
                                            ...
                                            update(keep_options, menu_to_show)
                                            t.sleep(0.5)
...
def update(keep_options, menu_to_show):
    shipInside()
